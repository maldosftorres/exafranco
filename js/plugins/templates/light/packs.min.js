...
function initial_header_setup(){hasCentralMenu=$('body').hasClass('btMenuCenterEnabled');verticalMenuEnabled=$('body').hasClass('btMenuVerticalLeftEnabled')||$('body').hasClass('btMenuVerticalRightEnabled');belowMenu=$('body').hasClass('btBelowMenu');btStickyEnabled=$('body').hasClass('btStickyEnabled');if(typeof window.btStickyOffset=='undefined')window.btStickyOffset=250;if(typeof window.responsiveResolution=='undefined')window.responsiveResolution='1200';$(document).ready(function(){$(document).ready(function(){var iSliderAgenda=1;$(document).on("click",'[data-open="video"]',function(){var element=$(this);var mybox=element.data('box');var box=$("[data-box-id='"+mybox+"']");box.attr('src','https://www.youtube.com/embed/'+element.data('view-video'))});$(document).on("click",'#open__full--game',function(){var element=$(this);var fullGame=$('#full__game');element.children('i').toggleClass('fa-chevron-down fa-chevron-up');fullGame.slideToggle('fast')});$(document).on('click',function(e){if($(e.target).closest(".topBarInMenu").length===0){$('.box__social__tab').hide()}});$('.btIconWidget').click(function(){$('.box__social__tab').show()})
$('.btIconWidget').click(function(){$('#box__inst').parent().attr('href',$(this).attr('data-inst'));$('#box__selec').parent().attr('href',$(this).attr('data-selec'));$('#box__inst i').attr('class',$(this).attr('data-class'));$('#box__selec i').attr('class',$(this).attr('data-class'))})
$(document).on("click",'.box__accordion--agenda .handle__',function(){var element=$(this);$('.box__accordion--agenda .content__').slideUp();$('.box__accordion--agenda .handle__').removeClass('is_open');if(element.parent().find('.content__').is(':visible')){element.parent().find('.content__').slideUp();element.removeClass('is_open')}else{element.parent().find('.content__').slideDown();element.addClass('is_open')}});$('.bt_src_load').Lazy();$(document).on("click",'#next__agenda--full',function(){var current=$('#item__slider--'+iSliderAgenda);iSliderAgenda=(parseInt(iSliderAgenda)+1);var next=$('#item__slider--'+iSliderAgenda);if(next.length){$(this).show();console.log(iSliderAgenda);current.hide();next.fadeIn()}else{$(this).hide();iSliderAgenda=(parseInt(iSliderAgenda)-1)}});$(document).on("click",'#prev__agenda--full',function(){var current=$('#item__slider--'+iSliderAgenda);iSliderAgenda=(parseInt(iSliderAgenda)-1);var prev=$('#item__slider--'+iSliderAgenda);if(prev.length){$(this).show();current.hide();prev.fadeIn()}else{$(this).hide();iSliderAgenda=(parseInt(iSliderAgenda)+1)}});$(document).on("swiperight",'.matchday-banner__content',function(){var current=$('#item__slider--'+iSliderAgenda);iSliderAgenda=(parseInt(iSliderAgenda)+1);var next=$('#item__slider--'+iSliderAgenda);if(next.length){console.log(iSliderAgenda);current.hide();next.fadeIn()}else{iSliderAgenda=(parseInt(iSliderAgenda)-1)}});$(document).on("swipeleft",'.matchday-banner__content',function(){var current=$('#item__slider--'+iSliderAgenda);iSliderAgenda=(parseInt(iSliderAgenda)-1);var prev=$('#item__slider--'+iSliderAgenda);if(prev.length){current.hide();prev.fadeIn()}else{iSliderAgenda=(parseInt(iSliderAgenda)+1)}})});$('.salon--fama__slider').slick({dots:!0,infinite:!0,speed:300,arrows:!1,slidesToShow:3,autoplay:!0,autoplaySpeed:4000,slidesToScroll:3,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3,infinite:!0,dots:!0,arrows:!1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2,arrows:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]});$('.box--slider__triunfos').slick({dots:!1,infinite:!0,speed:300,arrows:!0,slidesToShow:3,autoplay:!0,prevArrow:"<button type=\"button\" class=\"slick-prev\" style=\"margin-left: 1.5rem; background-color: rgba(4, 29, 53, 0.64);\">",nextArrow:"<button type=\"button\" class=\"slick-next\" style=\"margin-right: 1.5rem; background-color: rgba(4, 29, 53, 0.64);\">",autoplaySpeed:4000,slidesToScroll:3,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3,infinite:!0,dots:!0,arrows:!1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2,arrows:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]});$('.box--slider__agenda').slick({dots:!1,infinite:!0,speed:300,arrows:!1,slidesToShow:1,autoplay:!0,autoplaySpeed:4000,slidesToScroll:1,centerPadding:'60px',responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3,infinite:!0,dots:!0,arrows:!1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2,arrows:!1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1,arrows:!1}}]})})}
...
function top_tools_search(){$('.mainHeader .btSearchInner').prependTo('body').addClass('btFromTopBox');$('.mainHeader .widget_search').addClass('btIconWidget');$('.mainHeader .btSearch, .btFromTopBox .btSearchInnerClose').on('click',function(){$('body').toggleClass('btTopToolsSearchOpen');return!1})}
...
$(window).load(function(){loadInitActions()});$(document).ready(function(){initRefreshCart()});initFancySelect();initFooter();initModernizrAndDetectBrowser();initPreloader();bt_initTheme=initTheme})(jQuery);'use strict';(function($){if(typeof magnificPopup==="function"){$('.gallery-item').magnificPopup({delegate:'a[href$=".jpg"], a[href$=".jpeg"], a[href$=".png"], a[href$=".gif"]',type:'image',gallery:{enabled:!0,preload:[0,2],navigateByImgClick:!0,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',tCounter:'<span class="mfp-counter">%curr% of %total%</span>'}})}
$('.__item_to_be_removed__').remove();$('.btSingleItemColumnInner:empty').remove();$('.slick-slider').each(function(i,slider){$(slider).addClass('bt_slider_childs_'+$(slider).find('.bt_bb_content_slider_item').length)});$('.bt_bb_show_dots_bottom > .slick-slider').each(function(i,slider){if($(slider).parent().parent().hasClass("btMediaBox"))return;var j=0;$(slider).on('init',function(event,slick){$(slider).find('ul.slick-dots li').each(function(j,dot){var temp_slide=$(slider).find('.slick-list .bt_bb_content_slider_item:eq('+j+')');var thumb_temp=$(temp_slide).data('thumb');var title_temp=$(temp_slide).find('.bt_bb_headline_content a').html();var date_temp=$(temp_slide).find('.btArticleDate').html();if(date_temp===undefined){var date_temp=$(temp_slide).find('.btArticleStarRating').html()}
...
if(thumb_output!=''){data_output=thumb_output+data_output}
if(data_output!=''){$(dot).html(data_output)}})})});$('li.btMenuWideDropdown').each(function(){var maxChildItems=0;$(this).find('.sub-menu.bt_mega_menu_content > li.bt_mega_menu_content_inner').each(function(index){var destination=$(this).parent().next('.sub-menu:not(.bt_mega_menu_content)');if(destination.length>0){var source=$(this);$(this).parent().remove();source.prependTo(destination)}})});$('.menuPort ul ul.sub-menu.bt_mega_menu_content').parent().find('.subToggler').remove();function isOnScreen(elem){var element=elem.get(0);if(element==undefined)return!1;var bounds=element.getBoundingClientRect();return bounds.top+75<window.innerHeight&&bounds.bottom>0}
...
jQuery('.loadMore').click(function(event){event.preventDefault();jQuery(this).closest('.bt_bb_section').addClass('btShowHidden')});$(window).on('scroll',function(){bt_load_images()});bt_load_images()})(jQuery);!function(a,b){"use strict";function c(){if(!e){e=!0;var a,c,d,f,g=-1!==navigator.appVersion.indexOf("MSIE 10"),h=!!navigator.userAgent.match(/Trident.*rv:11\./),i=b.querySelectorAll("iframe.wp-embedded-content");for(c=0;c<i.length;c++){if(d=i[c],!d.getAttribute("data-secret"))f=Math.random().toString(36).substr(2,10),d.src+="#?secret="+f,d.setAttribute("data-secret",f);if(g||h)a=d.cloneNode(!0),a.removeAttribute("security"),d.parentNode.replaceChild(a,d)}}}
...
for(d=c.length;d--;)f.call(this,b,c[d]);else for(d in b)b.hasOwnProperty(d)&&(e=b[d])&&("function"==typeof e?f.call(this,d,e):g.call(this,d,e));return this},d.removeEvent=function(a){var b,c=typeof a,d=this._getEvents();if("string"===c)delete d[a];else if("object"===c)
...
function g(a,b,c){if(!(this instanceof g))return new g(a,b,c);"string"==typeof a&&(a=document.querySelectorAll(a)),this.elements=f(a),this.options=d({},this.options),"function"==typeof b?c=b:d(this.options,b),c&&this.on("always",c),this.getImages(),j&&(this.jqDeferred=new j.Deferred);var e=this;setTimeout(function(){e.check()})}
